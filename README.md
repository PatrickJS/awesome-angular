...
* [ngx-dropzone-next](https://github.com/arturovt/ngx-dropzone-next) - A maintained fork of `ngx-dropzone`, providing bug fixes and compatibility with newer Angular versions.
