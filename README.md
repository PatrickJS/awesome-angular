...
* [angular-eslint-zoneless](https://github.com/cyrilletuzi/angular-eslint-zoneless) - Checks that a zoneless application does not use Zone.js-based features and that signals/resources patterns are used.
