...
* [rm-image-slider](https://github.com/malikrajat/rm-image-slider) - An Angular standalone, responsive image slider with lightbox, lazy loading, video (YouTube/MP4) support, and high optimization.
