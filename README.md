...
* [ngx-api-mimic](https://github.com/mateuszbilicz/ngx-api-mimic) - This library lets you mock data and create fake API under HTTP Interceptor inside Angular apps.
