...
* [acontplus-libs](https://github.com/acontplus/acontplus-libs) - A Nx monorepo containing Angular libraries providing Domain-Driven Design (DDD) architecture, core utilities, and Angular Material UI components for enterprise applications.
