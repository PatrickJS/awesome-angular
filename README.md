...
* [@moltendb-web/angular](https://github.com/maximilian27/moltendb-web) - High-performance Rust/WASM local-first database for Angular. Features deep Signal integration, OPFS persistence, GraphQL like query syntax, and a dedicated Web Worker architecture for lag-free data processing at scale.
