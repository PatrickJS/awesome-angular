...
* [angular-estree-parser](https://github.com/prettier/angular-estree-parser) - A parser that converts Angular template source code into an ESTree-compatible AST.
